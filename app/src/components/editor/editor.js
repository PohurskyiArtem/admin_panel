...
export default class Editor extends Component {
    ...
    restoreBackup(e, backup) {
        ...
        UIkit.modal.confirm("Вы действительно хотите восстановить страницу из этой резервной копии? Все несохранённые данные будут потеряны!", {labels: {ok: "Восстановить", cancel: "Отмена"}})
        .then(() => {
            this.isLoading();
            return axios
    ...
    render() {
        ...
        if(!auth) {
            return <Login login={this.login} lengthError={loginLengthError} logErr={loginError}/>
        }
        ...
        return (
            <>
                ...
                <ConfirmModal 
                    ...
                    text={{
                        title: "Выход",
                        descr: "Вы действительно хотите выйти из административной панели?",
                        btn: "Выйти"
                    }}/>
